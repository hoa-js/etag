...
export const generateDigest = async (
  ...
  generator: (body: Uint8Array) => ArrayBuffer | Promise<ArrayBuffer>): Promise<string | null> => {
  ...
  return Array.prototype.map.call(new Uint8Array(result), (x: number) => x.toString(16).padStart(2, '0')).join('')
}
